...
from monai_legacy_aspire.networks.blocks.convolutions import Convolution, ResidualUnit
from monai_legacy_aspire.networks.layers.factories import Norm, Act
from monai_legacy_aspire.networks.layers.simplelayers import SkipConnection
from monai_legacy_aspire.utils import export, alias


@export("monai_legacy_aspire.networks.nets")
@alias("Unet")
class UNet(nn.Module):
    def __init__(
        ...
        # print("u net activation: ", self.act)
